...
// // mlx_put_image_to_window(game->mlx, game->mlx_win, game->render_img, 0,
// 0);

// mlx_hook(game->mlx_win, 2, 1L << 0, handle_key_press,
// game);		// KeyPress
// mlx_hook(game->mlx_win, 3, 1L << 1, handle_key_release,
// game);
// KeyRelease
