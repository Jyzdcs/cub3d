...
#    Updated: 2025/11/10 14:55:31 by kclaudan         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# MiniLibX library
# For Linux: Install Linux MiniLibX in libs/minilibx/mlx directory
MLX_DIR = libs/minilibx/mlx
